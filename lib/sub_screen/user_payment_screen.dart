                                                          ...
                                                          itemBuilder: (BuildContext context, int index) {
                                                            return InkWell(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                  // color: Colors.red,
                                                                  border: Border.all(color: payment == index ? notifier.test : Colors.grey.withOpacity(0.4)),
                                                                  borderRadius: BorderRadius.circular(15),
                                                                ),
                                                                child: Center(
                                                                  child: ListTile(
                                                                    ...
                                                                    trailing: Radio(
                                                                      ...
                                                                      fillColor:  WidgetStatePropertyAll(notifier.test),
                                                                      groupValue: true,
                                                                      onChanged: (value) {
                                                                        print(value);
                                                                        setState(() {
                      ...
                      Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('${widget.currency} ${widget.ticketPrice}',style:  TextStyle(color: notifier.test,fontSize: 15,fontWeight: FontWeight.bold),),
                          ),
                        ],
                      ),
                      const SizedBox(height: 15,),
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(convertTimeTo12HourFormat(widget.busPicktime),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test),maxLines: 1,overflow: TextOverflow.ellipsis),
                                    const SizedBox(height: 8,),
                                    const SizedBox(height: 8,),
                                  ],
                                ),
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8,),
                                    Text(convertTimeTo12HourFormat(widget.busDroptime),style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test),maxLines: 1,overflow: TextOverflow.ellipsis),
                                    const SizedBox(height: 8,),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: ListTile(
                                ...
                                trailing:  Icon(Icons.keyboard_arrow_right,color: notifier.test),
                              ),
                            ),
                          ],
                        ),
