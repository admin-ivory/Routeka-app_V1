...
class _Booking_ScreenState extends State<Booking_Screen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isloading ?  Center(child: CircularProgressIndicator(color: notifier.test)) :  Column(
        children: [
          Expanded(
            child: Padding(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Text('$searchbus${data.tickethistory[index].subtotal}',style:  TextStyle(color: notifier.test,fontSize: 15,fontWeight: FontWeight.bold),),
                                            ],
                                          ),
                                          const SizedBox(height: 15,),
                                          Row(
                                            ...
                                            children: [
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(convertTimeTo12HourFormat(data.tickethistory[index].busPicktime),style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test)),
                                                      const SizedBox(height: 8,),
                                                    ],
                                                  ),
                                                ),
                                              ...
                                              Column(
                                                children: [
                                                  Image(image: const AssetImage('assets/Auto Layout Horizontal.png'),color:notifier.test,width: 120,height: 50,),
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(height: 8,),
                                                      Text(convertTimeTo12HourFormat(data.tickethistory[index].busDroptime),style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test)),
                                                      const SizedBox(height: 8,),
                                                    ],
                                                  ),
                                                ),
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              const Spacer(),
                                              const SizedBox(width: 4,),
                                              Text('$searchbus${data1.tickethistory[index].ticketPrice}',style:  TextStyle(color: notifier.test,fontSize: 15,fontWeight: FontWeight.bold),),
                                            ],
                                          ),
                                          const SizedBox(height: 15,),
                                          Row(
                                            ...
                                            children: [
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(height: 8,),
                                                      Text(convertTimeTo12HourFormat(data1.tickethistory[index].busPicktime),style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test),),
                                                      const SizedBox(height: 8,),
                                                    ],
                                                  ),
                                                ),
                                              ...
                                              Column(
                                                children: [
                                                  Image(image: const AssetImage('assets/Auto Layout Horizontal.png'),height: 50,width: 120,color: notifier.test),
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(height: 8,),
                                                      Text(convertTimeTo12HourFormat(data1.tickethistory[index].busDroptime),style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test),),
                                                      const SizedBox(height: 8,),
                                                    ],
                                                  ),
                                                ),
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              const Spacer(),
                                              const SizedBox(width: 4,),
                                              Text('$searchbus${data2.tickethistory[index].ticketPrice}',style:  TextStyle(color: notifier.test,fontSize: 15,fontWeight: FontWeight.bold),),
                                            ],
                                          ),
                                          const SizedBox(height: 15,),
                                          Row(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(height: 8,),
                                                      Text(convertTimeTo12HourFormat(data2.tickethistory[index].busPicktime),style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test),),
                                                      const SizedBox(height: 8,),
                                                    ],
                                                  ),
                                                ),
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(height: 8,),
                                                      Text(convertTimeTo12HourFormat(data2.tickethistory[index].busDroptime),style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.test),),
                                                      const SizedBox(height: 8,),
                                                    ],
                                                  ),
                                                ),
