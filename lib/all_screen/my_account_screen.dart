    ...
    return GetBuilder<HomeController>(
        builder: (homeController) {
          return Scaffold(
            ...
            body: isloading ? Center(child: CircularProgressIndicator(color: notifier.test),) : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    InkWell(
                              ...
                              child:  Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    const SizedBox(height: 10,),
                                    CommonButton(txt1: 'Confirm'.tr,containcolore: notifier.test,context: context,onPressed1: () {
                                      Get.back();
                      ...
                      child: ListTile(
                        leading: Transform.translate(offset: const Offset(-25, 0),child: CircleAvatar(backgroundColor: Colors.grey.withOpacity(0.2),radius: 35,child: Text(userData['name'][0],style:  TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: notifier.test)),)),
                        ...
                        trailing:  Image(image: const AssetImage('assets/pen-line.png'),height: 25,width: 25,color: notifier.test),
                      ),
                    ),
                    const SizedBox(height: 10,),
                                                  ...
                                                  itemBuilder: (context, index) {
                                                    return GestureDetector(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            border: Border.all(color: value == index ? notifier.test : Colors.transparent,),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text('Delete Account'.tr,style:  TextStyle(color:notifier.test,fontWeight: FontWeight.bold,fontSize: 20)),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton(
                                          style: ButtonStyle(fixedSize: const WidgetStatePropertyAll(Size(130, 40)),elevation: const WidgetStatePropertyAll(0),shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),backgroundColor:  WidgetStatePropertyAll(notifier.test)),
                                          onPressed: () => {
                                            // resetNew(),
                          ...
                          builder: (BuildContext context) {
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  const SizedBox(height: 25,),
                                  Text('Logout'.tr,style:  TextStyle(color: notifier.test,fontWeight: FontWeight.bold,fontSize: 20)),
                                  const SizedBox(height: 25,),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(width: 10,),
                                      ElevatedButton(
                                        style: ButtonStyle(fixedSize: const WidgetStatePropertyAll(Size(120, 40)),elevation: const WidgetStatePropertyAll(0),shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),backgroundColor:  WidgetStatePropertyAll(notifier.test)),
                                        onPressed: () => {
                                          resetNew(),
                                          // Navigator.push(context, MaterialPageRoute(builder: (context) => const Login_Screen(),)),
                                          homeController.setselectpage(0),
