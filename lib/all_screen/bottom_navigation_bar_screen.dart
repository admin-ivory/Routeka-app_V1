        ...
        builder: (homeController) {
          return Scaffold(
            bottomNavigationBar: BottomNavigationBar(
              ...
              items:  <BottomNavigationBarItem>[
                BottomNavigationBarItem(
                  icon: homeController.selectpage == 0 ?  Padding(
                    ...
                    child: Image(image: const AssetImage('assets/Bottom Fill Home.png'),height: 22,width: 22,color: notifier.test),
                  ):  const Padding(
                ...
                BottomNavigationBarItem(
                  icon: homeController.selectpage == 1 ?  Padding(
                    padding: const EdgeInsets.only(bottom: 5),
                    child: Image(image: const AssetImage('assets/Bottom Fill Fill Ticket.png'),height: 24,width: 24,color: notifier.test),
                  ):const Padding(
                    padding: EdgeInsets.only(bottom: 5),
                ...
                BottomNavigationBarItem(
                  icon: homeController.selectpage == 2 ?  Padding(
                    padding: const EdgeInsets.only(bottom: 5),
                    child: Image(image: const AssetImage('assets/Bottom Fill Wallet.png'),height: 19,width: 19,color: notifier.test),
                  ):const Padding(
                    padding: EdgeInsets.only(bottom: 5),
                ...
                BottomNavigationBarItem(
                  icon:homeController.selectpage == 3 ?  Padding(
                    padding: const EdgeInsets.only(bottom: 5),
                    child: Image(image: const AssetImage('assets/Bottom Fill Account.png'),height: 20,width: 20,color: notifier.test),
                  ):const Padding(
                    padding: EdgeInsets.only(bottom: 5),
              ...
              selectedItemColor: notifier.test,
              onTap: _onItemTapped,
            ),
            body: Center(
